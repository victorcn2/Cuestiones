...
palabras_a<-nchar(gsub("[a]","",texto))
palabras_a

consonantes<-nchar(gsub("[^aeiouáéíóú]","",texto))
consonantes
...
Nosotros<-Nosotros%>%mutate(suma=as.numeric(dmy("03-02-2021")-as.numeric(dmy(Nosotros$`FechaNac(DD-MM-YYY)`))))
suma<-sum(Nosotros$suma/365)
suma
```
